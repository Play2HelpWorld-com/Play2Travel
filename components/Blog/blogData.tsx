...
const BlogData: Charity[] = [
  {
    ...
    title: "Play2Travel World Water Aid",
    metadata:
      "The game’s graphics are vibrant, and the soundtrack is uplifting, creating an immersive experience. What makes it stand out is its integration with real-world charity initiatives—players' achievements can trigger actual donations to global humanitarian efforts..",
  },
  {
  ...
  },
  {
    ...
    title: "Play2Travel World MSF Doctors Without Borders",
    metadata: "The game’s graphics are vibrant, and the soundtrack is uplifting, creating an immersive experience. What makes it stand out is its integration with real-world charity initiatives—players' achievements can trigger actual donations to global humanitarian efforts.",
  },
  {
  ...
  },
  {
    ...
    title: "Play2Travel Cancer Research",
    metadata: "The game’s graphics are vibrant, and the soundtrack is uplifting, creating an immersive experience. What makes it stand out is its integration with real-world charity initiatives—players' achievements can trigger actual donations to global humanitarian efforts.",
  },
  {
  ...
  },
  {
    ...
    title: "Play2Travel Alzheimer's Society",
    metadata: "The game’s graphics are vibrant, and the soundtrack is uplifting, creating an immersive experience. What makes it stand out is its integration with real-world charity initiatives—players' achievements can trigger actual donations to global humanitarian efforts.",
  },
  {
